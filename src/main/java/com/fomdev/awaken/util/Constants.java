...
public class Constants
{
    ...
    public static final String[] enchantmentAspects = new String[]{
            ...
            "fire_protection|awaken:natural = 450, awaken:advent = 50",
            "feather_falling|awaken:earth = 450, awaken:natural = 35, awaken:soul = 15",
            "blast_protection|awaken:doom = 450, awaken:water = 40, awaken:void = 10",
            "projectile_protection|awaken:grace = 450, awaken:void = 50",
            "respiration|awaken:abyss = 450, awaken:vividity = 50",
            "aqua_infinity|awaken:water = 450, awaken:liquidize = 25, awaken:misery = 25",
            "thorns|awaken:blood = 400, awaken:kill = 50, awaken:void = 50",
            "depth_strider|awaken:void = 400, awaken:vintage = 100",
            "frost_walker|awaken:ice = 250, awaken:natural = 100, awaken:sanity = 100, awaken:soul = 50",
            "soul_speed|awaken:soul = 450, awaken:zen = 50",
            "swift_sneak|awaken:peace = 400, awaken:ascend = 50, awaken:water = 50",
            "sharpness|awaken:blood = 250, awaken:death = 250",
            "smite|awaken:blood = 250, awaken:death = 250",
            "bane_of_arthropods|awaken:misery = 500",
            "knockback|awaken:oomph = 250, awaken:death = 250",
            "fire_aspect|awaken:natural = 250, awaken:death = 200, awaken:earth = 50",
            "looting|awaken:greed = 250, awaken:sanity = 200, awaken:vintage = 50",
            "sweeping_edge|awaken:death = 250, awaken:blood = 250",
            "efficiency|awaken:quality = 250, awaken:soul = 200, awaken:natural = 50",
            "silk_touch|awaken:truth = 450, awaken:natural = 50",
            "unbreaking|awaken:rock = 500",
            "fortune|awaken:destiny = 400, awaken:natural = 50, awaken:soul = 50",
            "power|awaken:oomph = 400, awaken:death = 50, awaken:blood = 50",
            "punch|awaken:oomph = 400, awaken:death = 50, awaken:blood = 50",
            "flame|awaken:natural = 400, awaken:earth = 100",
            "infinity|awaken:world = 250, awaken:death = 200, awaken:blood = 50",
            "luck_of_the_sea|awaken:fate = 250, awaken:natural = 150, awaken:water = 100",
            "lure|awaken:water = 250, awaken:natural = 150, awaken:luxury = 100",
            "loyalty|awaken:faith = 400, awaken:soul = 50, awaken:vividity = 50",
            "impaling|awaken:kill = 500",
            "riptide|awaken:water = 500",
            "channeling|awaken:destiny = 450, awaken:natural = 50",
            "multishot|awaken:greed = 400, awaken:death = 50, awaken:blood = 50",
            "quick_charge|awaken:advent = 400, awaken:death = 100",
            "piercing|awaken:kill = 400, awaken:death = 100",
            "density|awaken:hearty = 400, awaken:death = 100",
            "breach|awaken:doom = 400, awaken:death = 100",
            "wind_burst|awaken:natural = 400, awaken:earth = 50, awaken:vividity = 50",
            "mending|awaken:cell = 1000"
    };
